 ...
 */
export const saveTask = (nome,sexo,email,cpf,rg,telefone,endereco,numero,cep,bairro,cidade,uf,complemento) =>
  addDoc(collection(db, "tasks"), { nome,sexo,email,cpf,rg,telefone,endereco,numero,cep,bairro,cidade,uf,complemento });
